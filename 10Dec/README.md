...
> [!WARNING]
> ※ このPythonはバージョンが古いので (3.6.8、現在の最新バージョンは 3.14.2と3.13.11)、Pythonの最近の機能やライブラリがいろいろ使えません。
...
```
(exp2_2025_nlp) [sudoh@gpc1x70 exp2_2025_nlp]$
```
...
## 7. 課題提出（時間内に終わらなくても提出期限までに提出すればOK）
